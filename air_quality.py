...
def run_app():
    ...
    if add_selectbox=='Seasonal ARIMA':
        ...
        seasonal_forecast.plot(figsize=(15, 10), color='green')
        df3['Nitrogen_dioxide'].plot(figsize=(15, 10))
        df3['predicted_test'].plot(figsize=(15, 10))
        plt.legend(fontsize=19)
    ...
    if add_selectbox=='LSTM':
        ...
        model.add(LSTM(50, activation='relu', input_shape=(1, time_step)))
